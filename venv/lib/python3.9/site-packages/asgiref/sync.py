...
class AsyncToSync(Generic[_P, _R]):
    ...
    # Reference to the CurrentThreadExecutor in local context, so that
    # any sync_to_async inside the wrapped code can find it.
    executors: "Local" = Local()

    # If can't find a CurrentThreadExecutor from the context, such as
    ...
    def __call__(self, *args: _P.args, **kwargs: _P.kwargs) -> _R:
        __traceback_hide__ = True  # noqa: F841 # flake8 python tool checks code for errors
        ...
        try:
            ...
            if not running_in_main_event_loop:
                ...
                if self.async_single_thread_context.get(None):
                    ...
                    # Make own event loop - in a new thread - and run inside that
                    loop_executor = ThreadPoolExecutor(max_workers=1)
    ...
    async def main_wrap(
        ...
        __traceback_hide__ = True  # noqa: F841 # flake8
        ...
        try:
            # If there is an exception, run the function inside the except block
    ...
    async def __call__(self, *args: _P.args, **kwargs: _P.kwargs) -> _R:
        ...
        if self._thread_sensitive:
            ...
            if current_thread_executor:
                ...
                # Otherwise, run it in a fixed single thread
